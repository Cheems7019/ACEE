...
DATASETS = {
    "nonlin_simpson": {
        "data_dir": "csuite_nonlin_simpson",
        "x0_low": -1,
        "x0_high": 1,
        "outcome_idx": 2,
        "intervention_idx": 0,
    ...
    "nonlin_simpson_nonadditive": {
        "data_dir": "csuite_nonlin_simpson_nonadditive",
        "x0_low": -1,
        "x0_high": 1,
        "outcome_idx": 2,
        "intervention_idx": 0,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Estimate ATE for csuite nonlin_simpson datasets using conditional diffusion."
    )
    ...
    parser.add_argument(
        "--datasets",
        type=str,
        default="nonlin_simpson,nonlin_simpson_nonadditive",
