...
def main():
    parser = argparse.ArgumentParser(
        description="Simulation for M2 ITE (heteroscedastic) with conditional diffusion model"
    )
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default=os.path.join(acee_root, "data", "M2"),
    )
    parser.add_argument(
        "--results_dir",
        type=str,
        default=os.path.join(acee_root, "results", "M2"),
    )
