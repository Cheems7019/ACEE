...
def main():
    parser = argparse.ArgumentParser(
        description="Transfer-learning ATE estimation for TM_positive with conditional diffusion."
    )
    ...
    parser.add_argument(
        "--results_dir",
        type=str,
        default=os.path.join(acee_root, "transfer_learning", "results", "TM_positive"),
    )
