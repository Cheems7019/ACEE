...
def main():
    parser = argparse.ArgumentParser(
        description="Bias-corrected ATE estimation for TM_positive using saved potential outcomes."
    )
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default=os.path.join(acee_root, "transfer_learning", "data", "TM_positive"),
    )
    parser.add_argument(
        "--results_dir",
        type=str,
        default=os.path.join(acee_root, "transfer_learning", "results", "TM_positive_bc"),
    )
